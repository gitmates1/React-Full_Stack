...
React-Full_Stack/
|__FrontEnd/ # React + Vite client
|__BackEnd/ # Express + MongoDB server
|__package.json # Root scripts for running both
...
npm run FrontEnd -> Runs only frontend
npm run BackEnd	-> Runs only backend

## Authors

Abubakar (22021519-079) & Arham (22021519-073)
Full Stack Developers

## License

This project is unlicensed (None).
Feel free to use, modify, or distribute without restrictions.
